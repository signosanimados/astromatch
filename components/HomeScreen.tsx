        ...
        <div className="w-full max-w-md space-y-4">
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-white mb-1">Descubra Seu Signo</h3>
                <p className="text-slate-400 text-sm">Quiz para descobrir qual signo mais combina com você</p>
              </div>
